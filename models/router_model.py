...
train_dir="/kaggle/input/datasets/deviprasadbrl/router-dataset/router_dataset/test"
test_dir="/kaggle/input/datasets/deviprasadbrl/router-dataset/router_dataset/test"
...
model.classifier=nn.Linear(num_fc, 4)
